<template>
  <div class="app">
    ...
    <footer class="params-footer">
      <p>本頁面以手續費比率 0.1425%（買賣皆收取，小數點捨去，最低 1 元）、交易稅可選擇正常稅率 0.3%、ETF 稅率 0.1% 或無交易稅 0%（僅賣出時收取，小數點捨去，最低 0 元）、最大成交金額 10,000 元為計算參數。手續費可於右上角輸入折扣。</p>
      <p>本功能僅計算參考的最小交易單位，不考慮當沖的情況。</p>
    </footer>
  </div>
</template>
